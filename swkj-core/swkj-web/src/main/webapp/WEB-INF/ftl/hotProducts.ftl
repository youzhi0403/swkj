    ...
    <div class="container">
        ...
        <div class="navigation">
            ...
            <ul class="primary">
                ...
                <li><a class="active" href="${contextPath}/selling.html">热销</a></li>
...
<div class="wrapper container">
    ...
    <#if list??>
        <#list list as series>
            <div class="col-sm-4 product-menu-item">

                <a href="${contextPath}<#if series.hotPage_url?? >${series.hotPage_url}<#else></#if>"
                   title="<#if series.s_name?? >${series.s_name}<#else></#if>">
                    <div class="product-menu-image-container"
                         style=" background-image:url(<#if series.picture_url?? >${series.picture_url}<#else></#if>)"></div>
                    <h5 class="product-menu-title"><#if series.s_name?? >${series.s_name}<#else></#if></h5>
                </a>
    ...
    <div class="wrapper">
        <div class="row">
            <div class="col-sm-4 footer-text">版权所有@广州化妆品有限公司，洛杉矶，CA，美国90017&nbsp;&nbsp;
                <!--<script type="text/javascript" src="../../cs.ecqun.com/-id=2566358.js"  charset="utf-8"></script>-->
...
<#list list as series>
    <div class="col-sm-4 product-menu-item">
        <a href="<#if series.hotPage_url?? >${series.hotPage_url}<#else></#if>" title="<#if series.s_name?? >${series.s_name}<#else></#if>"
        <div class="product-menu-image-container" style=" background-image:url(<#if series.picture_url?? >${series.picture_url}<#else></#if>)"></div>
        <h5 class="product-menu-title"><#if series.s_name?? >${series.s_name}<#else></#if></h5>
        </a>
    </div>
</#list>
