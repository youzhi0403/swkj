...
<div class="wrapper container">
    ...
    <#if pLines??>
        <#list pLines as pLine>
            <div class="col-sm-4 product-menu-item">
                <a href="${contextPath}${pLine.page_url}" title="${pLine.s_name}">
                    <div class="product-menu-image-container"
                         style=" background-image:url(${pLine.picture_url})"></div>
                    <h5 class="product-menu-title">${pLine.s_name}</h5>
                </a>
            </div>
        </#list>
    <#else >
